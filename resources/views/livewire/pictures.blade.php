<div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <div class="relative">
                ...
                <div class="absolute bottom-0 inset-x-0 bg-transparent px-3 py-2 flex justify-end space-x-2">
                    ...
                    <button class="outline-none focus:outline-none" wire:click.prevent="showDeletePictureModal({{ $p }})">
    ...
    <x-jet-dialog-modal wire:model="showDeleteModal">
        ...
        <x-slot name="content">
            ...
            <div class="py-2">
                <img src="{{ $picthumbnailUrl }}"
                    alt="Picture to Delete" class="h-auto w-full object-cover border border-gray-200">
            </div>
        </x-slot>
        ...
        <x-slot name="footer">
            ...
            <x-jet-danger-button class="ml-2" wire:click="deletePicture" wire:loading.attr="disabled">
                {{ __('Delete Picture') }}
            </x-jet-danger-button>
        </x-slot>
    </x-jet-dialog-modal>
